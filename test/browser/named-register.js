suite('Named System.register', function () {
  suiteSetup(function () {
    return System.import('../../dist/extras/named-register.js').then(
      function () {},
    );
  });
  ...
  test('Loading a named AMD bundle', function () {
    return System.import('./fixtures/browser/named-amd.js')
      .then(function (m) {
        assert.equal(m.a, 'b');
  ...
  test('Loading a single named System.register module', function () {
    return System.import('./fixtures/browser/single-named-module.js').then(
      function (m) {
  ...
  test('Loading a named register module as both top level import and linked dependency', function () {
    return System.import('named-register-single-execute')
      .then(function (m) {
      ...
      .then(function () {
        return System.import(
          './fixtures/browser/named-register-single-execute-as-dep.js',
        );
      })
      .then(function (m) {
        assert.equal(m.bonjour, 'bonjour');
  ...
  test('loading named define module should work and should not instantiate it twice', function () {
    return System.import('fixtures/amd-named-single-execute.js')
      .then(function (m) {
        assert.equal(m.default, 'The first named AMD module');
        assert.equal(numNamedAMDExecutions, 1);
      })
      .then(function () {
        return System.import('fixtures/amd-named-single-execute.js').then(
          function (m) {
            assert.equal(m.default, 'The first named AMD module');
            assert.equal(numNamedAMDExecutions, 1);
          },
  ...
  test('loading a module after manual named register should return the loaded module', function () {
    ...
    return System.import('fixtures/amd-named-thing-as-dep.js').then(
      function (m) {
  ...
  test('Bundles with named register do not instantiate last module more than once', function () {
    ...
    return System.import('./fixtures/browser/named-instantiate-count.js').then(
      function (urlModule) {
        // Then import the same module via named register name
        return System.import('named-instantiate-count').then(
  ...
  test('Named bundles that self import', function () {
    // First import the module via URL
    return System.import('./fixtures/browser/named-self-import.js').then(
      function (urlModule) {
        // Then import the same module via named register name

...
import type { ImportMap, RawImportMap, SystemJSLoader } from './types';

export const System: SystemJSLoader = global.System;

// branded loader property key (see BASE_URL / IMPORT_MAP in common.ts)
const IMPORT_MAP_PROMISE: typeof IMPORT_MAP_PROMISE_KEY = Symbol() as any;
...
systemJSPrototype.resolve = function () {
  if (!this[IMPORT_MAP]) {
    ...
    this[IMPORT_MAP] = { imports: {}, scopes: {} } as ImportMap;
  }
...
export function applyImportMap(loader: SystemJSLoader, newMap: RawImportMap, mapBase?: string) {
  ...
  loader[IMPORT_MAP] = loader[IMPORT_MAP] || { imports: {}, scopes: {} } as ImportMap;

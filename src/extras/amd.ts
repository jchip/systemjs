...
import type { ImporterSetter, Registration } from '../types';
...
(function (global: any) {
  ...
  function createAMDRegister (amdDefineDeps: string[], amdDefineExec: any): Registration {
    var exports = {};
    var module: { exports: any, uri?: string } = { exports: exports };
    var depModules: any[] = [];
    var setters: ImporterSetter[] = [];
    var splice = 0;
    ...
    function createSetter(idx: number) {
  ...
  global.define = function (arg1: any, arg2: any, arg3: any) {

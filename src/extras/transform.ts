 ...
 */
(function (global: any) {
  var systemJSPrototype: SystemJSLoader & { transform: (id: string, source: string) => string | Promise<string> } = global.System.constructor.prototype;

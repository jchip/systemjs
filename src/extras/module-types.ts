  ...
  systemJSPrototype.fetch = function (url, options) {
    ...
    .then(function (res) {
      ...
      if (wasmContentType.test(contentType!))
        return ((WebAssembly as any).compileStreaming ? WebAssembly.compileStreaming(res as any) : (res as any).arrayBuffer().then(WebAssembly.compile))
        .then(function (module: any) {
          ...
          var deps: string[] = [];
          var setterSources: string[] = [];
          if ((WebAssembly.Module as any).imports)

...
(function (global: any) {
  ...
  var lastRegisterDeclare: any;
  var systemRegister = systemJSPrototype.register;
  systemJSPrototype.register = function (name, deps, declare) {
    lastRegisterDeclare = typeof name === 'string' ? declare : deps;
    systemRegister.apply(this, arguments as any);
  };
  ...
  systemJSPrototype.getRegister = function () {
    ...
    register[1] = function (this: any, _export, _context) {
      // hook the _export function to note the default export
      var defaultExport: any, hasDefaultExport = false;

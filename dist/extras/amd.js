...
const err_msg_js_1 = require("../err-msg.js");
/*
...
(function (global) {
    ...
    function unsupportedRequire() {
        throw Error(process.env.SYSTEM_PRODUCTION ? (0, err_msg_js_1.errMsg)(5) : (0, err_msg_js_1.errMsg)(5, 'AMD require not supported.'));
    }
    ...
    global.define = function (arg1, arg2, arg3) {
        ...
        // define(function () {})
            ...
            throw Error(process.env.SYSTEM_PRODUCTION ? (0, err_msg_js_1.errMsg)(9) : (0, err_msg_js_1.errMsg)(9, 'Invalid call to AMD define()'));
        }
        ...
        if (isNamedRegister) {
            if (System.registerRegistry) {
                ...
                console.warn(process.env.SYSTEM_PRODUCTION
                    ? (0, err_msg_js_1.errMsg)('W6')
                    : (0, err_msg_js_1.errMsg)('W6', 'Include named-register.js for full named define support'));
